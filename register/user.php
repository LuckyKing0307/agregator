...
<?php require('../module/header.php') ?>
    <section class="head_title" style="margin-top: 40px; margin-bottom: 40px;">
            <div class=" container">
                <div class="row">
                <div class=" header_wrapper">
                    <a href="index.php" class="link header_link">< Назад на главную</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="col-md-10">
            ...
            <div class="col-md-6">
                    <div class="information1">
                        <?php if (isset($user['img'])) { ?>
                            <img src="img/<?php echo $user['img'] ?>" alt="" class="  ava" class="img">
                        <?php } ?>
                        <div class="user_information">
                            <div class="names"><?php echo $row['surname'].' '.$row['name'].' '.$row['fathername']; ?></div>
                            <div class="birth">10.10.1990</div>
                            <div class="names">
        <?php if ($user['agent_check']==1) { ?>
        <a href="new_user.php" class="btns1 btn1">Оформить полис</a>
        <?php }else{ ?>
        ...
        <input type="submit" class="btns1 btn1" name="btn" value="Оформить полис">
        <input type="checkbox" name="agent_form" checked hidden>
