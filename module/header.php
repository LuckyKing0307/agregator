          ...
          <div class="container container-my">
            <div class="row">
              ...
              <div class="offset-md-3 col-md-3 justify-content-between menu_wrap dn">
                  <button class="head-btn menu "><a href="https://goldpreis.ru/register/login.php">Войти</a></button>
                  <button class="head-btn menu "><a href="https://goldpreis.ru/register/">Регистрация</a></button>
              </div>
                <?php } ?>
            </div>
          </div>
